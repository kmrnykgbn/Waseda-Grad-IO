...
\FunctionTok{print}\NormalTok{(res\_elas\_mat)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{init\_p }\OtherTok{\textless{}{-}} \FunctionTok{rep}\NormalTok{(}\FloatTok{0.025}\NormalTok{, }\FunctionTok{nrow}\NormalTok{(df))}
